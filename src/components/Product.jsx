...
const Product = ({ product}) => {
    console.log(product)
    const { photo, details, name, type, price } = product;
    ...
    return (
        ...
        <div className="card px-1 py-3 bg-black shadow-xl hover:scale-110 transition border border-red-700">
            <img className="w-full h-64 object-cover " src={photo} />
